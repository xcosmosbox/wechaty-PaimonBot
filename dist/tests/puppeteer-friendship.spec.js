...
const puppet_wechat_1 = require("../src/puppet-wechat");
...
tstest_1.test('PuppetWeChatFriendship.receive smoke testing', async (t) => {
...
tstest_1.test('PuppetWeChatFriendship.confirm smoke testing', async (t) => {
