...
blue_tape_1.default('PuppetWeChatBridge', async (t) => {
...
/* eslint indent: off */
blue_tape_1.default('preHtmlToXml()', async (t) => {
...
blue_tape_1.default('testBlockedMessage()', async (t) => {
    const BLOCKED_HTML_ZH = [
        '<pre style="word-wrap: break-word; white-space: pre-wrap;">',
        '&lt;error&gt;',
        '&lt;ret&gt;1203&lt;/ret&gt;',
  ...
  `;
    ...
    blue_tape_1.default('en', async (t) => {
        const memory = new memory_card_1.MemoryCard();
        const bridge = new bridge_1.default({ memory });
...
blue_tape_1.default('clickSwitchAccount()', async (t) => {
...
blue_tape_1.default('WechatyBro.ding()', async (t) => {
